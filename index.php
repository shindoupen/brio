...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>CRM</b>brio</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        ?>
          	<li class="treeview">
	          	...
	          	<?php
	          		$sub_menu =  $query->getSubMenu($menu['id_menu']);
              	...
              	?>
              			...
              			<?php
              				foreach ($sub_menu[1] as $key ) 
              				{
              			?>
              					<li>
              						<?php
              							$sub_menu_level_2 =  $query->getSubMenuLevel2($key['id_sub_menu']);
						            ...
						            ?>
						              			...
						              			<?php
						              				foreach ($sub_menu_level_2[1] as $var ) 
						              				{
						              			?>
						              					<li>
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; 2022 <a href="http://sincodes.com">Sincodes</a>.</strong> All rights
    reserved.
  </footer>
